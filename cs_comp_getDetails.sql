...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_comp_getDetails', N'P') IS NOT NULL
    DROP PROCEDURE dbo.cs_comp_getDetails;
GO
CREATE PROCEDURE dbo.cs_comp_getDetails
