/*****************************************************************************
** dbo.cs_comp_getLocalVehicles
** stored procedure
**
** Description
** Selects a set of current comp records for AV service
...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_comp_getLocalVehicles', N'P') IS NOT NULL
    DROP PROCEDURE dbo.cs_comp_getLocalVehicles;
GO
CREATE PROCEDURE dbo.cs_comp_getLocalVehicles
...
BEGIN
	...
	SELECT 
		...
		WHERE cs_comp_viewHistory.date_closed IS NULL
