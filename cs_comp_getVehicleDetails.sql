/*****************************************************************************
** dbo.cs_comp_getVehicleDetails
** stored procedure
**
** Description
** Selects AV customer care data for a given complaint_no
**
** Parameters
...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_comp_getVehicleDetails', N'P') IS NOT NULL
    DROP PROCEDURE dbo.cs_comp_getVehicleDetails;
GO
CREATE PROCEDURE dbo.cs_comp_getVehicleDetails
