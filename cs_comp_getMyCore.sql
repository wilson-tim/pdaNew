/*****************************************************************************
** dbo.cs_comp_getMyCore
** stored procedure
**
** Description
** Selects a set of current comp records for Core service and a given officer
**
** Parameters
** @username = user name
**
...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_comp_getMyCore', N'P') IS NOT NULL
    DROP PROCEDURE dbo.cs_comp_getMyCore;
GO
CREATE PROCEDURE dbo.cs_comp_getMyCore
