/*****************************************************************************
** dbo.cs_compertdetail_updateRecord
** stored procedure
**
** Description
** Update comp_ert_detail records for specified lookup_func
...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_compertdetail_updateRecord', N'P') IS NOT NULL
    DROP PROCEDURE dbo.cs_compertdetail_updateRecord;
GO
CREATE PROCEDURE dbo.cs_compertdetail_updateRecord
...
BEGIN
	...
	/* More efficient to delete all comp_ert_detail records */
	...
	BEGIN CATCH
		...
		SET @errortext   = 'Error deleting comp_ert_detail records';
		GOTO errorexit;
	END CATCH
