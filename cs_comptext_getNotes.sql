/*****************************************************************************
** dbo.cs_comptext_getNotes
** user defined function
**
** Description
** Get concatenated customer care notes data for a given complaint_no
...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_comptext_getNotes', N'FN') IS NOT NULL
    DROP FUNCTION dbo.cs_comptext_getNotes;
GO
CREATE FUNCTION dbo.cs_comptext_getNotes
(
