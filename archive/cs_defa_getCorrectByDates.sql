...
GO
CREATE PROCEDURE dbo.cs_defa_getCorrectByDates
	@cb_time_id integer,
	@item_ref varchar(12),
...
endcase2:
	...
	/* MS SQL Server 2012 introduced function DATETIMEFROMPARTS which supersedes this */
	SET @new_cdatetime = 
		DATEADD(minute, @time_m_int,
		DATEADD(hour,   @time_h_int,
		DATEADD(day,    DATEPART(day,   @new_cdatetime) - 1, 
		DATEADD(month,  DATEPART(month, @new_cdatetime) - 1, 
		DATEADD(year,   DATEPART(year,  @new_cdatetime) - 1900, 0)))));
