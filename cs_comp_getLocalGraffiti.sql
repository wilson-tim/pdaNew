/*****************************************************************************
** dbo.cs_comp_getLocalGraffiti
** stored procedure
**
** Description
** Selects a set of current comp records for Graffiti service
...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_comp_getLocalGraffiti', N'P') IS NOT NULL
    DROP PROCEDURE dbo.cs_comp_getLocalGraffiti;
GO
CREATE PROCEDURE dbo.cs_comp_getLocalGraffiti
...
BEGIN
	...
	SELECT 
		...
		WHERE dbo.cs_utils_getServiceType(cs_comp_viewHistory.service_c) = 'ERT'
