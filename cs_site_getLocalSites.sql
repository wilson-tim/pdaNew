...
BEGIN
	...
	SELECT site_detail.site_ref,
		...
		(dbo.cs_site_getPropertySortkey(locn.location_name, cteSite.build_no, cteSite.build_name, cteSite.build_sub_name, cteSite.build_sub_no)) AS site_sortkey,
	...
	ORDER BY site_sort, site_distance, site_sortkey;
