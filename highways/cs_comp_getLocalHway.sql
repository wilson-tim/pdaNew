/*****************************************************************************
** dbo.cs_comp_getLocalHway
** stored procedure
**
** Description
** Selects a set of current comp records for Highways service
...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_comp_getLocalHway', N'P') IS NOT NULL
    DROP PROCEDURE dbo.cs_comp_getLocalHway;
GO
CREATE PROCEDURE dbo.cs_comp_getLocalHway
...
BEGIN
	...
	SELECT 
		...
		WHERE dbo.cs_utils_getServiceType(cs_comp_viewHistory.service_c) = 'HWAY'
