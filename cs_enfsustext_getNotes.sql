/*****************************************************************************
** dbo.cs_enfsustext_getNotes
** user defined function
**
** Description
** Get concatenated enforcement suspect notes data for a specified enforcement suspect
...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_enfsustext_getNotes', N'FN') IS NOT NULL
    DROP FUNCTION dbo.cs_enfsustext_getNotes;
GO
CREATE FUNCTION dbo.cs_enfsustext_getNotes
(
	@suspect_ref integer,
	@noteslen integer
)
