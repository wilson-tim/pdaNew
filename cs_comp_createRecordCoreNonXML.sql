/*****************************************************************************
** dbo.cs_comp_createRecordCoreNonXML
** stored procedure
**
** Description
...
** 10/04/2013  TW  Renamed as cs_comp_createRecordCoreNonXML
** 01/07/2013  TW  Added processing for fly capture data
** 11/07/2013  TW  Double check for @feature_ref
** 17/07/2013  TW  Remove call to cs_customer_updateRecord
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_comp_createRecordCoreNonXML', N'P') IS NOT NULL
    DROP PROCEDURE dbo.cs_comp_createRecordCoreNonXML;
GO
CREATE PROCEDURE dbo.cs_comp_createRecordCoreNonXML
	/* key data */
	@entered_by varchar(8) OUTPUT,
	@site_ref varchar(16) OUTPUT,
	@site_name_1 varchar(70) = NULL OUTPUT,
	@exact_location varchar(70) = NULL OUTPUT,
	@service_c varchar(6) OUTPUT,
	@service_c_desc varchar(40) = NULL OUTPUT,
	@comp_code varchar(6) OUTPUT,
	@comp_code_desc varchar(40) = NULL OUTPUT,
	@item_ref varchar(12) OUTPUT,
	@item_desc varchar(40) = NULL OUTPUT,
	@feature_ref varchar(12) = NULL OUTPUT,
	@feature_desc varchar(40) = NULL OUTPUT,
	@contract_ref varchar(12) = NULL OUTPUT,
	@contract_name varchar(40) = NULL OUTPUT,
	@action_flag varchar(2) = 'H' OUTPUT,
	...
	@int_ext_flag varchar(1) = NULL OUTPUT,
	/* other data */
	@complaint_no integer = NULL OUTPUT,
	@date_entered datetime = NULL OUTPUT,
	@ent_time_h varchar(2) = NULL OUTPUT,
	@ent_time_m varchar(2) = NULL OUTPUT,
	@dest_ref integer = NULL OUTPUT,
	@dest_suffix varchar(6) = NULL OUTPUT,
	@date_due datetime = NULL OUTPUT,
	@date_closed datetime = NULL OUTPUT,
	@incident_id varchar(20) = NULL OUTPUT,
	@details_1 varchar(70) = NULL OUTPUT,
	@details_2 varchar(70) = NULL OUTPUT,
	@details_3 varchar(70) = NULL OUTPUT,
	@notice_type varchar(1) = NULL OUTPUT
	/* fly capture */
	,@landtype_ref varchar(6) = NULL OUTPUT
	,@dominant_waste_ref varchar(6) = NULL OUTPUT
	,@dominant_waste_qty integer = NULL OUTPUT
	,@load_ref varchar(2) = NULL OUTPUT
	,@load_unit_cost decimal(7,2) = NULL OUTPUT
	,@load_qty integer = NULL OUTPUT
	,@load_est_cost decimal(7,2) = NULL OUTPUT
AS
BEGIN
	...
	*/
	...
	IF dbo.cs_utils_getServiceType(@service_c) IN ('AV', 'ENF', 'ENFTR', 'HWAY', 'SL')
	BEGIN
