/*****************************************************************************
** dbo.cs_compertdetail_getLookupCodeDescListSP
** stored procedure
**
** Description
...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_compertdetail_getLookupCodeDescListSP', N'P') IS NOT NULL
    DROP PROCEDURE dbo.cs_compertdetail_getLookupCodeDescListSP;
GO
CREATE PROCEDURE dbo.cs_compertdetail_getLookupCodeDescListSP
