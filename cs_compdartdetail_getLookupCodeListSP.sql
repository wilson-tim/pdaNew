/*****************************************************************************
** dbo.cs_compdartdetail_getLookupCodeListSP
** stored procedure
**
** Description
...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_compdartdetail_getLookupCodeListSP', N'P') IS NOT NULL
    DROP PROCEDURE dbo.cs_compdartdetail_getLookupCodeListSP;
GO
CREATE PROCEDURE dbo.cs_compdartdetail_getLookupCodeListSP
