/*****************************************************************************
** dbo.cs_compertdetail_createRecord
** stored procedure
**
** Description
** Create comp_ert_detail records using passed data
**
** Parameters
...
**
*****************************************************************************/
IF OBJECT_ID (N'dbo.cs_compertdetail_createRecord', N'P') IS NOT NULL
    DROP PROCEDURE dbo.cs_compertdetail_createRecord;
GO
CREATE PROCEDURE dbo.cs_compertdetail_createRecord
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			END TRY
			BEGIN CATCH
				SET @errornumber = '20227';
				SET @errortext = 'Error inserting comp_ert_detail record';
				GOTO errorexit;
			END CATCH
			...
			END TRY
			BEGIN CATCH
				SET @errornumber = '20228';
				SET @errortext = 'Error inserting comp_ert_dtl_log record';
				GOTO errorexit;
			END CATCH
